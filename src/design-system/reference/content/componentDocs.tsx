...
// The component reference entries, one per documented primitive, and the
// shapes they are written in. Data, kept apart from the ComponentDoc page so
// that file exports only components and keeps fast refresh.
