...
const COLOR_GROUPS: readonly ColorGroup[] = [
  {
    ...
    roles: [
      ...
      { label: "Wash", path: "color.surface.wash", note: "A faint wash of ink: the well a module sinks media into, the fill of a chip." },
      { label: "Wash strong", path: "color.surface.washStrong", note: "The wash one step up, for a selected chip or a panel inside a well." },
