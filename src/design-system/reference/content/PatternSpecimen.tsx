      ...
      <div className="flex gap-2 overflow-x-auto border-b border-hairline pb-3 md:block md:space-y-1 md:border-b-0 md:border-r md:pb-0 md:pr-5">
        {sections.map((section) => (
          <button
            ...
            className={`min-h-[40px] shrink-0 rounded-sm px-3 text-left text-caption transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus md:block md:w-full ${active === section ? "bg-surface-wash text-foreground" : "text-foreground-tertiary hover:text-foreground-secondary"}`}
          >
            {section}
          </button>
        ))}
