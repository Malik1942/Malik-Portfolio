...
const aura: ProjectDetailDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "## Gap Between Discomfort and Support\n\nMotion sickness builds gradually before travelers fully recognize discomfort.\n\n**Opportunity: Support should begin before discomfort becomes difficult to manage.**\n\n## Audio as Intervention\n\nThe 100 Hz research helped narrow Aura’s intervention strategy from multi-modal coping to a focused audio-first approach.\n\n[[fig:0]]\n\n**Decision: Use calming audio as Aura’s first response, giving travelers support without requiring visual attention or active input.**\n\n## Current Solution Landscape\n\nI compared existing remedies across medication, patches, wristbands, pressure tools, breathing, sleep, distraction, and sensory support.\n\n[[fig:1]]\n\nMost solutions shared the same limitation: they are either prepared before symptoms or used after discomfort begins.\n\n**Gap: Few solutions support travelers during the early buildup phase.**\n\n## Research Takeaway\n\nTravelers already cope with discomfort through music, sleep, breathing, or medication, but these strategies depend on noticing symptoms early.\n\n**Decision: Aura should sense early risk and prepare support before travelers have to actively manage discomfort.**",
    },
    {
      id: "ideation",
      label: "Ideation",
      ...
      body: "## From Relief Product to Anticipatory System\n\nResearch pointed to a clear direction: Aura needed to support travelers earlier, with less effort in the moment. In ideation, we explored app-based guidance, pressure-based wearables, visual reduction tools, environmental supports, and audio-centered concepts.\n\n[[fig:0]]\n\nThe matrix clarified a key tradeoff: concepts that were easy to build often depended on user action, while physical remedies lacked the sensing and context needed for proactive support. This led us to choose the earbud direction.\n\n[[fig:1]]\n\n[[module:aura-ideation-criteria]]\n\n**Decision: Focus on an audio-first wearable system: one that could sense early risk, interpret flight context, and intervene quietly before symptoms escalated.**",
    },
    {
      id: "testing",
      label: "Testing",
