...
import calmmouseCard from "@/assets/calmmouse-card.webp";
  ...
  sections: [
    ...
    },
    {
      ...
      figures: [
        ...
        { type: "image", src: moodmuseModules, alt: "The three-pod essential-oil diffuser render, a flat drawing of the diffuser, and a drawing of the magnetic charger receptacle with N and S poles and three contacts", full: true },
