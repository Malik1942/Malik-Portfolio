  ...
  sections: [
    {
      ...
      body: "**For motion-sensitive travelers, the hardest part of the journey often begins before they even reach the sky.**\n\n**Aura explores a more proactive approach: supporting travelers before discomfort becomes hard to control.**\n\nAura is a speculative ear-worn system and companion app that predicts motion-sickness risk and delivers subtle support before symptoms fully emerge. By combining physiological sensing, motion context, and calming audio interventions, Aura helps travelers prepare for discomfort before they have to actively manage it.\n\n**In this 5-person team project, I contributed across product design, industrial design, system logic, and physical prototyping.** My main role was translating an invisible physiological problem into a coherent hardware and software system: one that senses early changes, predicts risk, and responds in a way that feels calm, trustworthy, and nearly invisible.",
    },
    {
      id: "situation",
      label: "Situation",
    ...
    },
    {
      ...
      body: "## From opportunity to product direction\n\nAfter research, we knew Aura should support travelers earlier, before motion sickness became difficult to manage. But the opportunity was still abstract: we had to decide what kind of product could actually sense risk, deliver support, and fit naturally into air travel.\n\nOur task was to translate \"proactive support\" into a concrete product direction: what intervention should Aura provide, what features should it include, and what physical interface could make the experience feel believable.\n\nAs a team, we explored three main directions: an eye mask, a wristband, and an ear-adjacent wearable. Each one suggested a different strategy. The eye mask focused on reducing visual input. The wristband focused on pressure-based relief. The ear-adjacent wearable opened up a broader system: sensing body and motion signals, delivering audio-based support, and fitting into an existing travel behavior.\n\n[[fig:0]]\n\nI helped compare these concepts through a 2 by 2 matrix based on user value and implementation feasibility. The ear-adjacent direction became the strongest fit because it could combine sensing, intervention, comfort, and everyday travel behavior into one coherent product system.\n\nI advocated for this direction because it gave Aura the clearest product logic: sense early risk, predict discomfort, and support travelers through subtle audio intervention. This helped the team converge on Aura Buds as the physical anchor of a proactive in-flight support system.",
    },
    {
      id: "testing",
      label: "Testing",
      ...
      figures: [
        { type: "image", src: auraApproach2, alt: "Aura user flow and system behavior" },
      ],
      body: "**I translated the concept into physical prototypes. I designed the product form, 3D printed the models, and tested them with users** to evaluate fit, stability, comfort, and weight distribution across different ears.\n\n[[fig:0]]\n\n**I tested the prototypes across users with different ear shapes, hairstyles, glasses, and wearing habits.** These sessions helped reveal issues that were not obvious in CAD, including pressure points, instability during head movement, and uneven weight distribution.\n\nThe V1 prototype used a more conventional in-ear structure. Testing showed that it was not stable enough and created uneven weight distribution — particularly during head movement. **That feedback made it clear the form needed to change.**",
    },
    {
      id: "refinement",
      label: "Refinement",
      ...
      body: "## Making Aura easier to wear, read, and trust\n\nTesting showed that Aura needed to become lighter in both form and interaction. The hardware had to feel stable on the ear, while the app had to communicate status without asking users to read or manage too much during travel.\n\n[[fig:0]]\n\nFor the hardware, I developed a second prototype with a more bar-oriented structure. This improved weight distribution, created more internal room for sensors and audio components, and opened up a clearer surface for gesture-based control. I also kept the form close to familiar earbud language so Aura could feel socially acceptable in public travel settings, not like a medical device or a speculative gadget.\n\nFor the app, I simplified the interface around quick, low-attention feedback. Instead of text-heavy explanations, I shifted the UI toward clearer visual patterns: icons, status cards, motion states, and subtle animation to show when Aura is monitoring, preparing support, or actively intervening. The goal was to make the system feel understandable at a glance.\n\nThe refinement connected both sides of the product. The buds became more wearable, and the app became more readable. Together, they helped Aura feel less like something users had to manage and more like a calm support layer during travel.\n\nThe key refinement was not only making Aura look better. It was making the whole system feel easier to wear, easier to understand, and easier to trust.",
    },
    {
      id: "final-design",
      label: "Final Design",
...
const neuralyfe: ProjectDetailDocument = {
  ...
  sections: [
    ...
    },
    {
      id: "research",
      label: "Research",
      body: "## Understanding where the detection gap is\n\nI started by researching CTE and how brain injury accumulates over time. A few key findings shaped the direction:\n\n· Sub-concussive hits rarely trigger immediate symptoms, but repeated exposure is strongly associated with progressive neurological damage.\n\n· Most sideline evaluations are triggered by a visible incident: a hard hit, a stumble, a slow reaction. By that point, the window for early intervention may have already passed.\n\n· Existing helmet sensors capture force data, but force alone does not tell you how the brain responded. The gap is between impact data and neurological signal.\n\nThis research pointed toward a different kind of tool: one that tracks cumulative brain-impact risk, not just flags individual hits.",
    },
    {
      id: "problem",
      label: "Design Challenge",
      body: "## From complex data to fast sideline decisions\n\nThe core design problem was not technical. It was interpretive.\n\nBrain activity, cumulative impact, affected regions, and biomarker signals are difficult to read in real time, especially during a live game. If the interface showed too much, it became overwhelming. If it simplified too much, it lost credibility.\n\nThe challenge was to design a system that could surface the most urgent information first, support fast triage, and let medical staff go deeper only when needed.\n\n**The question I kept returning to:** What does a sideline medic need to know in the next five seconds?",
    },
    {
      id: "system-direction",
      label: "System Direction",
      body: "## Two layers working together\n\nThe system concept is built on two connected layers.\n\n**Halo** is a helmet add-on that captures impact data and physiological signals during play. Rather than replacing existing equipment, Halo integrates with helmets teams already trust. It includes three sensing layers:\n\n· EEG sensors that map brain activity and connectivity\n· Biomarker sensors that track early neurological stress indicators (p-Tau 217, NfL, GFAP)\n· An impact camera that reconstructs plays and verifies hits\n\n**The sideline interface** takes those signals and translates them into a medical decision workflow. Instead of surfacing raw sensor output, it structures the information around three questions: Who needs attention? What is happening in their brain? What caused it?\n\nThis hardware-to-interface connection was the core product logic: the interface is only as useful as the signals behind it, and the hardware is only as useful as the interface that makes sense of it.",
    },
    {
      id: "process",
      label: "Design Process",
      body: "## Building the decision flow\n\nI started by mapping the sideline workflow. Medical staff do not have time to explore data during a game. The interface needed to support fast triage first, then deeper inspection only when needed.\n\nThat led to a three-level structure:\n\n· **Roster View** for scanning risk across the whole team at a glance\n· **Brain View** for inspecting where neurological stress is building\n· **Impact Replay** for tracing a high-risk alert back to the exact play\n\nI prototyped the interface in Figma and Figma Make, using simulated helmet sensor data to build the visual states: player risk scores, brain region stress, cumulative impact patterns, and play-based hit analysis.\n\nThroughout the process, I kept pressure-testing one assumption: could a medical staff member move from first alert to informed decision within a few seconds? That question shaped the visual hierarchy, the information density, and the flow between views.",
    },
    {
      id: "final-design",
      label: "Final Design",
    ...
    },
    {
      id: "impact",
      label: "Impact",
      body: "NeuraLyfe makes a clear design claim: brain injury risk should not remain hidden until symptoms appear.\n\nMy contribution was translating that claim into a working prototype. I helped frame the problem, shape the product logic, define the three core views, design the interaction flow, and build the system in Figma and Figma Make.\n\nThe final prototype shows how sideline teams could move from a raw impact alert to a confident medical decision: scan the roster, inspect brain stress, trace the risk to the play, and act before damage becomes irreversible.\n\n**NeuraLyfe was awarded 1st Place at FigBuild 2026, recognized for its concept, execution, and system design.**",
    },
    {
      id: "reflection",
      label: "Reflection",
