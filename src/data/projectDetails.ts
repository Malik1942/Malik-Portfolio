...
const aura: ProjectDetailDocument = {
  ...
  sections: [
    ...
    },
    {
      id: "final-design",
      label: "Final Design",
      body: "The final design brings together Aura Buds, the Aura App, and in-travel interventions into one closed-loop support system. The buds sense early physiological and motion signals, the app prepares and personalizes the experience, and ambient audio interventions support the traveler before discomfort fully emerges.\n\n[[fig:0]]\n\n## Aura Buds\n\nAura Buds were not designed as a standalone earbud form. **I treated the hardware as the physical interface of the system: the place where sensing, intervention, comfort, and social acceptance had to come together.**\n\n**I defined the key hardware features based on the system’s needs and the pain points of travel.** Noise cancellation creates a calmer ambient environment during flights and transit. Heart-rate and HRV sensing help detect physiological shifts before motion sickness becomes conscious. A ceramic-filter air tunnel helps equalize pressure and reduce airplane ear. The speaker unit supports 100 Hz grounding tones, breathing guidance, calming soundscapes, and everyday earbud use. An LED indicator communicates wellness status at a glance without requiring users to open the app.\n\n[[fig:1]]\n\n[[fig:2]]\n\nThis feature set shaped the form development. The product needed enough internal space for sensors and audio components, enough surface area for gesture interaction, and a weight distribution that could stay comfortable during long travel periods. Early concepts leaned toward more distinctive silhouettes, but testing showed that novel forms created more pressure points, more self-consciousness, and less willingness to wear the product in public for hours.\n\nThat led to a clearer design direction: familiarity was not a compromise, but a system requirement. A recognizable earbud silhouette made Aura feel socially acceptable, while the bar-oriented structure improved weight distribution, created room for integrated components, and supported more intuitive gesture control.\n\n**I iterated stem length, angle, fit, and component placement through critique sessions and contextual testing, including head movement, conversation, and extended sitting.** The final direction reflects my system thinking process: designing the hardware not only as an object, but as a quiet, wearable layer of a proactive travel-support system.\n\n## Aura App\n\nThe app had a tricky job: be useful enough to matter, invisible enough not to undercut the hardware’s calm.\n\n**I held it to one principle: guided, not demanding.** That meant:\n\n· **Onboarding** does setup and pairing, then gets out of the way.\n\n· **Trips** are added in advance so the system has context without needing real-time input.\n\n· **Sound profiles** default to sensible states. Customization exists but doesn’t greet the user.\n\n· **Status feedback** reassures without surveilling.\n\n## In-Travel Experience\n\nAura’s real test is in motion. **I built storyboard scenarios grounded in specific travel moments** — before takeoff, during turbulence, and after intervention — to stress-test whether the system’s timing and tone held up under real travel pressure.\n\nScenario 1: We’re about to take off. Pause your screen and put on your AuraBuds. Let’s do a few rounds of 4-7-8 breathing while a steady 100 Hz tone helps you feel grounded.\n\nScenario 2: Heads up, we’ll hit some moderate bumps in about 10 minutes. Let’s get you ready now.\n\nIn both cases, Aura has already read the body signals and flight context. The intervention isn’t reactive — it’s prepared. The storyboards weren’t decoration. They were how I showed that sensing, prediction, and ambient support come together as one coherent experience.",
      figures: [
