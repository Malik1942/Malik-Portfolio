...
const aura: ProjectDetailDocument = {
  ...
  sections: [
    ...
    },
    {
      id: "refinement",
      label: "Refinement",
      body: "Based on the testing feedback, **I developed a bar-oriented form in V2** that improved balance, created more internal space for components, and opened up a larger surface area for gesture-based control.\n\nThis process led to a key design principle: **familiarity was not a compromise, but a system requirement.** A recognizable earbud-like form made Aura feel socially acceptable in public travel settings, while the bar-oriented structure supported the technical and ergonomic needs of the system.\n\n**The final form emerged from testing, not from style.** Each refinement was driven by a specific failure mode: instability became a weight-distribution problem, which became a bar-oriented form, which became the foundation for everything that followed.",
    },
    {
      id: "final-design",
      label: "Final Design",
