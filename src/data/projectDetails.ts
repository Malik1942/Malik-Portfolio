...
const aura: ProjectDetailDocument = {
  ...
  sections: [
    ...
    },
    {
      id: "discovery",
      label: "Discovery",
      body: "Our team first reviewed the current landscape of motion-sickness solutions, including medication, patches, wristbands, and sensory-based products. **I noticed that most of these solutions shared the same limitation: they respond only after users already feel discomfort.**\n\n**That observation reframed the opportunity.** If most existing tools are reactive, there is a design gap at the moment before symptoms are obvious — when the body is already registering instability but the user hasn’t yet reached the point of active discomfort.\n\nThis became the direction I pushed the project toward: not another tool for managing symptoms, but a system designed to prepare support before the user needs to ask for it.",
    },
    {
      id: "research",
      label: "Research",
