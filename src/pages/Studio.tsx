...
const Studio = () => {
  ...
  return (
    <PageTransition>
      {/* Same skill lens as the homepage: `/studio?lens=…` dims the tiles the
          same way, and the bar's cross-page link carries the lens back. */}
      <LensProvider>
      <div className="min-h-screen bg-background">
        ...
        {/* Two grids under two eyebrows (STUDIO_GROUPS): the software, closed by
            the GitHub strip, then the industrial design. */}
        <div className="mt-14 md:mt-20">
          <ProjectList
            section="studio"
            projects={projectsInSection("studio")}
            showLabel={false}
            trailing={{ software: <GitHubStrip /> }}
          />
        </div>
