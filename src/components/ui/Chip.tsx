 ...
 * module. Two kinds of material: `passive` is low-contrast and inert, `link`
 * carries a filled surface and stronger ink so it reads as clickable at a
 * glance. The link material is what LinkChip uses.
 */
