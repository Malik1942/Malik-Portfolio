  ...
  routes: [
    {
      ...
      holds: [
        ...
        { id: "a1", x: 160, y: 330, r: 10, shape: "sloper", rotation: 20 },
        { id: "a2", x: 55, y: 300, r: 11, shape: "jug", rotation: -30 },
        { id: "a3", x: 110, y: 240, r: 10, shape: "pinch", rotation: 15 },
        { id: "a4", x: 150, y: 150, r: 10, shape: "sloper", rotation: -15 },
        { id: "a5", x: 35, y: 190, r: 9, shape: "crimp", rotation: 10 },
        { id: "a6", x: 200, y: 210, r: 10, shape: "sloper", rotation: 35 },
  ...
  routes: [
    {
      ...
      holds: [
        ...
        { id: "a1", x: 93, y: 340, r: 9, shape: "sloper", rotation: 20 },
        { id: "a2", x: 20, y: 320, r: 10, shape: "jug", rotation: -30 },
        { id: "a3", x: 58, y: 250, r: 9, shape: "pinch", rotation: 15 },
        { id: "a4", x: 93, y: 160, r: 9, shape: "sloper", rotation: -15 },
        { id: "a5", x: 25, y: 175, r: 8, shape: "crimp", rotation: 10 },
