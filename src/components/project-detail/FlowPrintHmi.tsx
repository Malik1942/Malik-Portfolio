...
// borders fell back to the default border color. They are removed rather than
// given a bracketed value, because bracketing them would start applying an
// opacity the mock has never rendered with. Reinstating them is a visual
