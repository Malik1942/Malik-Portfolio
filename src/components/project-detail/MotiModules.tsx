...
function PendingScreen({ note }: { note: string }) {
  return (
    <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-case-study-module-border bg-surface-wash px-6 py-16 text-center">
